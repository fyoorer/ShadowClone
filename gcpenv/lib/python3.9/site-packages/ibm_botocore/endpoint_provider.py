...
go to any `endpoint-rule-set.json` file in /ibm_botocore/data/<service>/<api version>/
...
from ibm_botocore.compat import IPV4_RE, quote, urlparse
from ibm_botocore.exceptions import EndpointResolutionError
