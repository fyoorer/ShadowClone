...
import ibm_botocore.tokens
from ibm_botocore import (
    UNSIGNED,
    __version__,
    handlers,
    invoke_initializers,
...
from ibm_botocore.compat import HAS_CRT, MutableMapping
from ibm_botocore.configprovider import (
...
from ibm_botocore.hooks import (
    EventAliaser,
    HierarchicalEmitter,
...
class Session:
    ...
    def _create_token_resolver(self):
        return ibm_botocore.tokens.create_token_resolver(self)
    ...
    def get_auth_token(self):
        """
        Return the :class:`ibm_botocore.tokens.AuthToken` object associated with
