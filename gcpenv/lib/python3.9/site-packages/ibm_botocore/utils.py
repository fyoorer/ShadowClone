...
from ibm_botocore.compat import HEX_PAT  # noqa: F401
from ibm_botocore.compat import IPV4_PAT  # noqa: F401
from ibm_botocore.compat import IPV6_ADDRZ_PAT  # noqa: F401
from ibm_botocore.compat import IPV6_PAT  # noqa: F401
from ibm_botocore.compat import LS32_PAT  # noqa: F401
from ibm_botocore.compat import UNRESERVED_PAT  # noqa: F401
from ibm_botocore.compat import ZONE_ID_PAT  # noqa: F401
...
class S3RegionRedirector:
    ...
    def __init__(self, endpoint_bridge, client, cache=None):
        ...
        warnings.warn(
            ...
            'internal replacement. A future version of ibm_botocore may remove '
            'this class.',
...
class JSONFileCache:
    ...
    CACHE_DIR = os.path.expanduser(os.path.join('~', '.aws', 'ibm_boto', 'cache'))
